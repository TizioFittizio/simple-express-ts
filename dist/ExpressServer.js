...
var ExpressServer = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve) {
                        _this.server = _this._app.listen(port, function () {
                            if (onStart)
                                onStart();
                            else
    ...
    ExpressServer.prototype.loadMiddlewares = function () {
        for (var _i = 0, _a = this.options.middlewares || []; _i < _a.length; _i++) {
            var middleware = _a[_i];
            this._app.use(middleware);
        }
    };
    ExpressServer.prototype.loadControllers = function () {
        for (var _i = 0, _a = this.options.controllers; _i < _a.length; _i++) {
    ...
    ExpressServer.prototype.loadController = function (controller) {
        ...
        var _loop_1 = function (route) {
            ...
            var middlewares = (instance.routesMiddlewares || [])
        ...
        var this_1 = this;
        for (var _i = 0, _a = instance.routes || []; _i < _a.length; _i++) {
            var route = _a[_i];
            _loop_1(route);
        }
    };
